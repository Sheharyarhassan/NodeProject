...
function Update() {
  ...
  useEffect(() => {
    api.get(`${process.env.REACT_APP_BASE_URL}user/getById/${id}`).then(response => {
  ...
  const handleSubmit = async (values, {resetForm}) => {
    ...
    try {
      const response = await api.put(`${process.env.REACT_APP_BASE_URL}user/Update/${id}`, payload)
